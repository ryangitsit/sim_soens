...
net_dict = load("net_dict.jld2")["data"]
@show typeof(net_dict)
@time stepper(net_dict)
@time stepper(net_dict)

# save("out_dict.jld2", "data", net_dict)
