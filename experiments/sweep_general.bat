...
@REM       --samples       50^
@REM       --eta           0.005^
@REM       --exp_name      target50_maxflux_ft_full^
@REM       --backend       julia_window^
@REM       --dataset       MNIST^
@REM       --max_offset    0.5^
@REM       --fixed         .5^
@REM       --rand_flux     0.005^
...
@REM changed to 32 bit at 5504 -- 6062
FOR /L %%i IN (5504,1,100000) DO (
...
@REM FOR /L %%i IN (1607,1,100000) DO (
@REM     python exp_MNIST_full.py^
@REM       --run           %%i^
@REM       --s_th          0.25^
@REM       --duration      2500^
