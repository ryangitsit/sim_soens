...
class neuron():    
    ...
    def __init__(self, **params):
        ...
        if self.loops_present == 'rtti':
            self.circuit_betas = [2*np.pi* 1/4, 2*np.pi* 1/4, 2*np.pi*1e2]
        self.junction_critical_current =  100
        self.junction_beta_c =  0.3
        if self.loops_present == 'ri':
            self.bias_current = 1.7 # dimensionless bias current        
        elif self.loops_present == 'rtti':
            self.bias_current = 2.0 # dimensionless bias current
        ...
        self.junction_critical_current__refraction =  100
        self.junction_beta_c__refraction =  0.3
        if self.loops_present__refraction == 'ri':
            self.bias_current__refraction = 1.7    
        elif self.loops_present__refraction == 'rtti':
            self.bias_current__refraction = 3.1 
        self.integration_loop_time_constant__refraction = 50
...
#         self.integration_loop_time_constant = self.tau_di
#         self.circuit_betas = [2*np.pi*1/4, 2*np.pi*1/4, self.beta_di]
...
#         self.junction_critical_current = 100
#         self.junction_beta_c = 0.3
#         # self.bias_current = ib
#         # self.integration_loop_time_constant = tau_ni
#         self.absolute_refractory_period = 20
#         self.normalize_input_connection_strengths = False
#         self.total_excitatory_input_connection_strength = 1
#         self.total_inhibitory_input_connection_strength = -0.5
#         self.offset_flux = 0
...
#         self.loops_present__refraction = 'ri'
#         # self.circuit_betas__refraction = [2*np.pi*1/4, 2*np.pi*1/4, beta_ref]
#         self.junction_critical_current__refraction = 100
#         self.junction_beta_c__refraction = 0.3
#         # self.bias_current__refraction = ib_ref
#         self.integration_loop_time_constant__refraction = 35
#         self.refractory_dendrite_connection_strength = 'auto'
        
#         # synapse to refractory dendrite
#         self.tau_rise__refraction = 0.02
#         self.tau_fall__refraction = 50
#         self.hotspot_duration__refraction = 3
#         self.spd_duration__refraction = 8
#         self.phi_peak__refraction = 50
                        
#         # transmitter
#         # self.integrated_current_threshold = s_th
#         self.light_production_delay = 2
#         self.source_type = 'qd'
...
#         self.__dict__.update(kwargs)
#         self.bias_current = self.ib_n
#         self.integration_loop_time_constant = self.tau_ni
...
#         #               offset_flux = self.offset_flux,
#         #               self_feedback_coupling_strength = self.self_feedback_coupling_strength)
#         neuron_dend_dict = kwargs
#         neuron_dend_dict['name'] = name = '{}__{}'.format(self.name,'nr_ni')
#         neuron_dend_dict['loops_present'] = self.loops_present
#         neuron_dend_dict['circuit_betas'] = self.circuit_betas
#         neuron_dend_dict['junction_critical_current'] = self.junction_critical_current
#         neuron_dend_dict['junction_beta_c'] = self.junction_beta_c
#         neuron_dend_dict['bias_current'] = self.bias_current
#         neuron_dend_dict['integration_loop_time_constant'] = self.integration_loop_time_constant
#         neuron_dend_dict['normalize_input_connection_strengths'] = self.normalize_input_connection_strengths
#         neuron_dend_dict['total_excitatory_input_connection_strength'] = self.total_excitatory_input_connection_strength
#         neuron_dend_dict['total_inhibitory_input_connection_strength'] = self.total_inhibitory_input_connection_strength
#         neuron_dend_dict['offset_flux'] = self.offset_flux
#         neuron_dend_dict['self_feedback_coupling_strength'] = self.self_feedback_coupling_strength

#         neuron_dendrite = dendrite(**neuron_dend_dict)
#         neuron_dendrite.is_soma = True    
...
#         # create dendrite for neuronal refraction
#         ref_dendrite_dict = kwargs
#         ref_dendrite_dict['name'] = '{}__dend_{}'.format(1,'refraction')
#         ref_dendrite_dict['ib'] = self.bias_current__refraction
#         ref_dendrite_dict['tau'] = tau_ref
#         ref_dendrite_dict['Ic'] = Ic
#         ref_dendrite_dict['integration_loop_time_constant'] = self.integration_loop_time_constant__refraction

#         ref_dendrite_dict['loops_present'] = self.loops_present__refraction
#         ref_dendrite_dict['circuit_betas'] = self.circuit_betas__refraction
#         ref_dendrite_dict['junction_critical_current'] = self.junction_critical_current__refraction
#         ref_dendrite_dict['junction_beta_c'] = self.junction_beta_c__refraction

#         print("REFRACTORY:",ref_dendrite_dict['name'])
#         # neuron_refractory_dendrite = dendrite(name = '{}__dend_{}'.format(self.name,'refraction'), loops_present = self.loops_present__refraction, circuit_betas = self.circuit_betas__refraction, 
#         #                                       junction_critical_current = self.junction_critical_current__refraction, junction_beta_c = self.junction_beta_c__refraction,
#         #                                       bias_current = self.bias_current__refraction, integration_loop_time_constant = self.integration_loop_time_constant__refraction)
#         neuron_refractory_dendrite = dendrite(**ref_dendrite_dict)
#         self.dend__ref = neuron_refractory_dendrite
